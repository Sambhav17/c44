class Game {
  ...
  start() {
    ...
    car1.addImage("carboost1",car1_boost)
    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
     
    car2.addImage("blast", blastImage);
car2.addImage("carboost2",car2_boost)
    cars = [car1, car2];
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      image(track, 100, -height * 5, width, 5 * 6);
  ...
  handlePlayerControls() {
    if (!this.blast) {
      ...
      if (keyIsDown(DOWN_ARROW)) {
        ...
        car2.changeImage("carboost2")
      }
      if (keyDown("w")) {
       
        car1.changeImage("carboost1")
      }
